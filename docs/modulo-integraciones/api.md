...
- `GET /integraciones/eventos?jobId=`
...
- Eventos emitidos: `JobIniciado`, `JobCompletado`, `JobFallido`, `JobReintentado`.

## Triggers
- `GET /integraciones/triggers?eventName=`
- `POST /integraciones/triggers`
- `PUT /integraciones/triggers/{id}`
- `POST /integraciones/triggers/{id}/execute`
