...
- El workflow de vacaciones debe incluir `legajoNumero` y `dias` en `datos`.
- Liquidación puede aplicar vacaciones aprobadas al procesar (`aplicarVacacionesWorkflow=true`).
