...
- [x] Endpoint protegido `/me` OK
 - [x] Smoke test ejecutado 2026-03-13 (docker compose prod)
...
## CI
- [x] build-test en PR: restore/build/test por `csproj` (ver `.github/workflows/ci.yml`)
...
- [x] E2E Playwright (Portal RH y Empleado) OK
- [x] Script `start-e2e.ps1` disponible
...
- [x] `GET /api/rh/v1/tiempos/turnos`
- [x] `GET /api/rh/v1/tiempos/horarios`
- [x] `GET /api/rh/v1/tiempos/fichadas`
- [x] `GET /api/rh/v1/tiempos/planillas`
